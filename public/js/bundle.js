      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'You have successefully logedin');
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'error loging out, try later');
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Your inforamtion hase ben updated');
          }
          _context.next = 10;
          break;
        case 7:
...
var updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(password_current, password, password_confirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Your Password hase ben updated');
          }
          _context2.next = 10;
          break;
        case 7:
...
var form_user_settings = document.querySelector('.form-user-settings');
...
if (form_user_data) {
  form_user_data.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.UpdateUser)(email, name);
  });
}
...
if (form_user_settings) {
  form_user_settings.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var password_current, password, password_confirm;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.querySelector('.btn-password-save').textContent = 'Updating...';
            password_current = document.querySelector('#password-current').value;
            password = document.querySelector('#password').value;
            password_confirm = document.querySelector('#password-confirm').value;
            _context.next = 7;
            return (0, _updateSettings.updatePassword)(password_current, password, password_confirm);
          case 7:
